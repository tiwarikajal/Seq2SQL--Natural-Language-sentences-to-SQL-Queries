...
class AggPredictor(nn.Module):
    def __init__(self, N_word, N_h, N_depth):
        ...
        self.gru = nn.GRU(input_size=N_word, hidden_size=N_h/2, num_layers=N_depth,
                          dropout=(0 if n_layers == 1 else 0.3), bidirectional=True)

        self.agg_col_name_enc = nn.GRU(input_size=N_word+N_h,
    ...
    def forward(self, x_emb_var, x_len, agg_emb_var, col_inp_var=None,
        ...
        h_enc, _ = run_lstm(self.gru, x_emb_var, x_len)
